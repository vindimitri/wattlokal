...
import { ProblemDoor } from "@/components/ProblemDoor";
import { SectionCurtain } from "@/components/SectionCurtain";
import { WasIstDoor } from "@/components/WasIstDoor";
  ...
  return (
    <>
      ...
      <div className="enwg-page">
        ...
        <SectionCurtain
          id="unser-ziel"
          ariaLabel="Unser Ziel"
          buttonLabel="Unser Ziel"
        >
        ...
        {/* 4 */}
        <SectionCurtain
          id="was-uns-noch-fehlt"
          ariaLabel="Was uns noch fehlt"
          buttonLabel="Was uns noch fehlt"
          className="bg-[#eef2f5]"
        >
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            ...
            <article className="enwg-card">
              ...
              <p className="mt-2 text-[color:var(--enwg-muted)] leading-relaxed">
                ...
                wir machen und wie viel Strom wir brauchen, ist es nur eine Frage
                der Zeit, bis uns der{" "}
                <strong className="font-semibold text-[color:var(--enwg-navy)]">
                  Versorger
                </strong>{" "}
                <strong className="font-semibold text-[color:var(--enwg-navy)]">
        ...
        <SectionCurtain
          id="rollen"
          ariaLabel="Erzeuger und Verbraucher"
          buttonLabel="Erzeuger und Verbraucher"
        >
