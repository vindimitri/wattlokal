  ...
  return (
    <>
      <section className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden">
        ...
        <div className="site-shell relative z-[1] py-20 text-center text-ink">
          ...
          <p className="rise rise-delay-2 mx-auto mt-6 max-w-md text-base sm:text-lg text-ink-muted leading-relaxed">
            Eine <strong className="font-semibold text-ink">Gemeinschaft</strong>, die{" "}
            <strong className="font-semibold text-ink">Watt</strong> teilt – für{" "}
            <strong className="font-semibold text-ink">Erzeuger</strong> und{" "}
      ...
      <section id="konzept" className="site-shell py-16 sm:py-24">
        <div className="max-w-2xl space-y-6 text-lg text-ink-muted leading-relaxed">
          <p>
          ...
          <p>
            ...
            <strong className="font-semibold text-ink">Strom</strong> bei{" "}
            <strong className="font-semibold text-ink">35&nbsp;ct</strong> pro{" "}
            <strong className="font-semibold text-ink">Kilowattstunde</strong> – und
            Haushalte mit{" "}
            <strong className="font-semibold text-ink">Solaranlage</strong> verkaufen
            ihren Strom für durchschnittlich{" "}
            <strong className="font-semibold text-ink">7&nbsp;ct</strong> pro{" "}
            <strong className="font-semibold text-ink">Kilowattstunde</strong>.
          </p>

          <p>
            Warum also solltest du als{" "}
            <strong className="font-semibold text-ink">Verbraucher</strong> mehr Geld
            zahlen und du als{" "}
            <strong className="font-semibold text-ink">Erzeuger</strong> weniger Geld
            bekommen? Das haben wir uns auch gefragt.
          </p>

          <p>
            Deshalb wollen wir die Menschen miteinander verbinden, die ihr{" "}
            <strong className="font-semibold text-ink">Watt</strong> teilen wollen.
          ...
          <p>
            ...
            <strong className="font-semibold text-ink">Freigabe</strong>. Doch
            zusammen können wir das schaffen. Wenn wir wissen, wie viel{" "}
            <strong className="font-semibold text-ink">Strom</strong> wir machen und
            wie viel Strom wir brauchen, ist es nur eine Frage der Zeit, bis uns
            der <strong className="font-semibold text-ink">Versorger</strong>{" "}
            <strong className="font-semibold text-ink">grünes Licht</strong> gibt.
            Dafür brauchen wir deine{" "}
            <strong className="font-semibold text-ink">Hilfe</strong>.
          </p>
        </div>
      </section>
      ...
      <section id="rollen" className="border-y border-line bg-[color:var(--surface)]">
        <div className="site-shell py-16 sm:py-20">
          <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl font-semibold text-ink">
            Für <strong className="font-semibold">Erzeuger</strong> und{" "}
            <strong className="font-semibold">Verbraucher</strong>
          </h2>
          <div className="mt-10 grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-3 text-ink-muted leading-relaxed">
                ...
                lokalen <strong className="font-semibold text-ink">Verbrauchern</strong>{" "}
                verbinden.
              </p>
            </div>
            <div>
          ...
          <p className="mt-10 max-w-2xl text-ink-muted leading-relaxed">
            Den gesetzlichen Rahmen seit dem{" "}
            <strong className="font-semibold text-ink">01.06.2026</strong> erklärt
            unsere Seite zu{" "}
            <Link
              href="/42c-enwg"
      ...
      <section className="site-shell py-16 sm:py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-lg text-ink-muted leading-relaxed">
            ...
            <strong className="font-semibold text-ink">Strom</strong> wir machen und
            brauchen, desto eher bekommen wir die{" "}
